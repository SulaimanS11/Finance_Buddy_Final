...
📚 Setting up collection: finance_textbooks...
✅ Collection ready
...
📄 Processing: options-trading-textbook.pdf
  📖 Extracting text...
  ✅ Extracted 45230 characters
  🧹 Cleaned to 44890 characters
  ✂️  Chunking text (size: 800, overlap: 150)...
  ✅ Created 67 chunks
  ...
  💾 Storing in ChromaDB...
  ✅ Successfully stored 67 chunks

📄 Processing: finance-guide.txt
  📖 Extracting text...
  ✅ Extracted 23450 characters
  ...
...
**Output:**
```
🚀 Generating 10 questions about "Options Trading"...
📚 Searching for relevant textbook content...
✅ Found relevant context (3245 characters)
📖 Using textbook content to tailor questions

🤖 Generating batch 1/4 (3 questions)...
✅ Batch 1 completed (3 questions)
...
```

**That's it!** Your quiz questions will now be based on your textbook content! 🎉
...
**Behavior:**
- ✅ If relevant context found → Questions tailored to your textbook
- ✅ If no context found → Questions generated using general knowledge
- ✅ If ChromaDB not running → Questions generated using general knowledge (with warning)
...
4. Result
   └─> Quiz with textbook-specific questions!
```
...
1. ✅ **Start ChromaDB**
2. ✅ **Add your first textbook** to `RAG_FILES/`
3. ✅ **Process it:** `node process-rag-files.js`
4. ✅ **Generate a quiz:** `node FinanceBuddy.js "Your Topic" 10`
5. ✅ **Enjoy tailored questions!** 🎉
